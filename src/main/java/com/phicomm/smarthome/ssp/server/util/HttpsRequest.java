...
import com.phicomm.smarthome.ssp.server.service.IServiceRequest;
...
public class HttpsRequest implements IServiceRequest {
    ...
    public String sendGet(String url) throws UnrecoverableKeyException, KeyManagementException, KeyStoreException,
        ...
        try {
            ...
            httpEntity = EntityUtils.toString(entity, "UTF-8");
            // 打印得到的响应信息
            Util.log("API，返回的数据是：");
            Util.log("=====Entity:" + httpEntity);
